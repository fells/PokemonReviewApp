...
namespace PokemonReviewApp
{
    public class Seed
    {
        ...
        public Seed(ConnectionContext context)
        {
            this.ConnectionContext = context;
        }
        public void SeedConnectionContext()
        {
            if (!ConnectionContext.PokemonOwners.Any())
            {
                var pokemonOwners = new List<PokemonOwner>()
                {
                    ...
                    new PokemonOwner()
                    {
                        ...
                        {
                            Name = "Venasuar",
                            BirthDate = new DateTime(1903,12,31).ToUniversalTime(),
                            PokemonCategories = new List<PokemonCategory>()
                            {
                ...
                ConnectionContext.PokemonOwners.AddRange(pokemonOwners);
